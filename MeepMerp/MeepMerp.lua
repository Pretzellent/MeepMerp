...
SlashCmdList.SOUNDTOMAKE = function()
	print("To change the sound made, navigate to <WoW Folder>/_classic_/Interface/AddOns/MeepMerp/ and change the copy over and rename your sound to meepmerp.mp3")
end